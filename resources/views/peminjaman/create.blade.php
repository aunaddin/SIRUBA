...
<div class="card shadow border-0">
    <div class="card-header bg-primary text-white d-flex align-items-center justify-content-between">
        <h5 class="mb-0"><i class="fas fa-calendar-plus me-2"></i> Tambah Peminjaman</h5>
    </div>
    <div class="card-body">
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="mb-3">
                        ...
                        <select name="bidang_id" id="bidang" class="form-control">
                            ...
                            @endforeach
                            <option value="lainnya" {{ old('bidang_id') == 'lainnya' ? 'selected' : '' }}>Lainnya</option>
                        </select>
                    </div>

                    <div class="mb-3" id="bidang_manual_container" style="display: {{ old('bidang_id') == 'lainnya' ? 'block' : 'none' }};">
                        <label for="bidang_manual" class="form-label"><i class="fas fa-pen me-1"></i> Bidang (Manual)</label>
                        <input type="text" name="bidang_manual" value="{{ old('bidang_manual') }}" class="form-control">
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="number" name="jumlah_peserta" class="form-control" value="{{ old('jumlah_peserta') }}" required>
                    </div>
                </div>
                ...
                <div class="col-md-6">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="nama_acara" class="form-control" value="{{ old('nama_acara') }}" required>
                    </div>
